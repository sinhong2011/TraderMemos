...
export function Input({
  ...
  const inputClassName = cn(
    "h-full w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] outline-none [transition:background-color_5000000s_ease-in-out_0s] placeholder:text-muted-foreground/72",
    ...
    <span
      className={
        cn(
          ...
          !unstyled && size === "default" && "h-8.5 sm:h-7.5",
          !unstyled && size === "sm" && "h-7.5 sm:h-6.5",
          !unstyled && size === "lg" && "h-9.5 sm:h-8.5",
          className,
        ) || undefined
      }
      data-size={size}
