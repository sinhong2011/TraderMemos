...
/** Root — default `modal={false}` matches prior dropdown-menu (nested filter menus). */
export function Menu({ modal = false, ...props }: MenuPrimitive.Root.Props): React.ReactElement {
