 ...
 *
 * Responsive: below `sm` the range label and rows-per-page share the first line
 * and the pager drops to its own centered line; ≥sm it collapses to one row.
 */
export function Pagination({
  ...
  return (
    ...
    >
      ...
      {/* `contents` lets the rows select and pager be direct nav items on mobile
          (label | rows, then pager on its own line); ≥sm they regroup right. */}
        ...
        {onPageSizeChange ? (
          <div className="flex items-center gap-1.5">
            ...
            <NativeSelect
              ...
              className="w-[4.25rem] px-2 pr-6 text-center text-[11px] tabular-nums text-muted-foreground"
            >
