...
import { AlertCircleIcon, CheckIcon, PlusIcon, XIcon, type LucideIcon } from "lucide-react";
...
const ICON_PLACEHOLDER_MAP: Record<string, LucideIcon> = {
  AlertCircleIcon,
  CheckIcon,
  PlusIcon,
  XIcon,
...
function IconPlaceholder({
  ...
  const Icon = lucide ? ICON_PLACEHOLDER_MAP[lucide] : undefined;
  if (!Icon) return null;
