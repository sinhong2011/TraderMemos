...
function SetupCard({
  ...
  return (
    ...
    >
      {/* Card header row */}
      <div className="flex items-start justify-between" style={{ padding: "10px 16px 0" }}>
        <div className="flex flex-col gap-0.5">
          ...
          {thesis && (
            <span style={{ fontSize: 11, color: "var(--color-text-muted)" }}>{thesis}</span>
          )}
          {checklist.length > 0 && (
            <span
              style={{
      ...
      {/* Stats row */}
      <div className="flex items-center gap-4 flex-wrap" style={{ padding: "6px 16px 10px" }}>
