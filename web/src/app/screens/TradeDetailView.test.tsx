...
import type { TradeDetail, Execution, TradeAttachment, Setup, Tag } from "../../lib/api/types";
...
const mockTags: Tag[] = [
  { id: "tag1", user_id: "u1", name: "Trending", color: "#34d399", description: "", kind: "custom" },
  { id: "tag2", user_id: "u1", name: "Chased entry", color: "#f87171", description: "", kind: "mistake" },
];
