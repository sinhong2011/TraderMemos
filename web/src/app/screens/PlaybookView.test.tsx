...
const setup: Setup = { id: "s1", name: "ORB", description: "Opening range breakout" } as Setup;
const group: BreakGroup = {
  key: "ORB",
  summary: {
    total_trades: 5, wins: 3, losses: 2, breakeven: 0, win_rate: 0.6,
    net_pnl: 500, gross_profit: 700, gross_loss: 200, profit_factor: 3.5,
    expectancy: 100, avg_win: 233.33, avg_loss: 100, avg_trade: 100,
    largest_win: 300, largest_loss: 120, total_fees: 10,
  },
} as BreakGroup;
