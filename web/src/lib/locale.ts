...
export const LOCALES: Record<
	AppLocale,
	{ label: string; nativeLabel: string; intl: string }
> = {
...
export const LOCALE_OPTIONS = (Object.keys(LOCALES) as AppLocale[]).map(
	(value) => ({
		value,
...
const SETTINGS_LABELS: Record<AppLocale, Record<SettingsLabelKey, string>> = {
	en: {
		...
		accountsDescription:
			"Manage broker accounts, starting balances, and cash flows.",
