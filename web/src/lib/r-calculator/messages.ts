...
const WARNINGS: Record<WarningKey, string> = {
  ...
  warn_capital_too_small_option: "Capital can't buy 1 contract — lower the premium or add capital",
  warn_risk_budget_too_small: "Risk budget under 1 contract — raise Risk% or tighten the stop",
  ...
  warn_fvg_account_too_small: "Account is too small to take even one share at this risk",
};
