 ...
 *
 * `ActivityConfiguration` requires the Dynamic Island builder even though only
 * iPhone 14 Pro and later render it; every other device shows the Lock Screen
 * card alone, which is where the countdown actually earns its keep.
 */
