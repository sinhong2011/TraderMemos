/**
 * Weekday × hour P&L bucketing, ported verbatim from web/src/lib/pnlHeatmap.ts
...
export function computePnlHeatmap(
  ...
  // Two dedicated formatters instead of one formatToParts pass: Hermes tags
  // the weekday part as "literal", so part types can't be trusted across
  // engines — plain format() output can.
