...
| Face ID app lock | **Dropped** (#137) — superseded by the iOS system per-app Face ID lock (long-press icon → Require Face ID); at most a Settings hint | Monetization plan |
