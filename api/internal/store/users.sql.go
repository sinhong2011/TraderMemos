...
UPDATE users SET is_admin = ? WHERE id = ? RETURNING id, email, password_hash, totp_secret, created_at, is_admin
`
...
UPDATE users SET totp_secret = ? WHERE id = ? RETURNING id, email, password_hash, totp_secret, created_at, is_admin
`
